        ...
        for (GridButton button : this.buttons)
        {
            button.getButton().setOnMouseClicked(e ->
            {
                ...
                if (mouseButton == MouseButton.SECONDARY)
                {
                    ...
                    {
                        SavedButtons.setButton10x10(button.getButton());
                        ...
                        if (button.isColorChanged() == true)
                        {
                            button.setColorChanged(false);
                            pane.getChildren().remove(button.getButton());
                            addButtons.addButtonToPane(button.getButton(), pane, 30, 30, widthPosition, heightPosition);
                        }
                    }
                }
